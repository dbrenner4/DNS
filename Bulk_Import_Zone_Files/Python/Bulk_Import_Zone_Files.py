...
# DynECT API
#
# Importing bulk zone files with the DynECT API in the Python Language.
#
# Author Jonathan Schultz - Integration Intern - Integration Team - Dyn Inc.
#
# Created 9/6/2012
# Update 9/11/2012
...
for zoneFileName in os.listdir(path):
    ...
    # Sending the the POST command to the DynECT API for login proposes.
...
for zoneFileName in os.listdir(path):
    ...
    if publish_zone['status'] != 'success':
        ...
        print 'Zone %s Published.' % zone_name
